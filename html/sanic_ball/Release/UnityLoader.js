...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'sanic_ball_dev.data';
    var REMOTE_PACKAGE_BASE = 'sanic_ball_dev.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 277909957;
      var PACKAGE_UUID = '4243e933-e71a-4dcd-aa5b-6509eb9da8df';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 31004, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(31004, 66188, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(66188, 79160, 0, 0).open('GET', '/level0');
    new DataRequest(79160, 299156, 0, 0).open('GET', '/level1');
    new DataRequest(299156, 492968, 0, 0).open('GET', '/level2');
    new DataRequest(492968, 2130440, 0, 0).open('GET', '/level3');
    new DataRequest(2130440, 2242024, 0, 0).open('GET', '/level4');
    new DataRequest(2242024, 2300028, 0, 0).open('GET', '/level5');
    new DataRequest(2300028, 2432168, 0, 0).open('GET', '/level6');
    new DataRequest(2432168, 2476604, 0, 0).open('GET', '/level7');
    new DataRequest(2476604, 2483682, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2483682, 2496775, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2496775, 2531759, 0, 0).open('GET', '/resources.assets');
    new DataRequest(2531759, 21140187, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(21140187, 25730474, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(25730474, 38833622, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(38833622, 89925030, 0, 0).open('GET', '/sharedassets1.resource');
    new DataRequest(89925030, 118078714, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(118078714, 128790806, 0, 0).open('GET', '/sharedassets2.resource');
    new DataRequest(128790806, 202050430, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(202050430, 203655192, 0, 0).open('GET', '/sharedassets3.resource');
    new DataRequest(203655192, 224130800, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(224130800, 224297648, 0, 0).open('GET', '/sharedassets4.resource');
    new DataRequest(224297648, 244338296, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(244338296, 263863680, 0, 0).open('GET', '/sharedassets6.assets');
    new DataRequest(263863680, 264488220, 0, 0).open('GET', '/sharedassets6.resource');
    new DataRequest(264488220, 272202672, 0, 0).open('GET', '/sharedassets7.assets');
    new DataRequest(272202672, 276312688, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(276312688, 277810060, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(277810060, 277882332, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(277882332, 277909957, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_sanic_ball_dev.data');

    };
    Module['addRunDependency']('datafile_sanic_ball_dev.data');
